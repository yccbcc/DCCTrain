...
Page({
  ...
  tap1: function() {
    console.log(this._allSendMsgs)
    var type = bleManager.type.cv_get_write
    for (let i = 0; i < this._allSendMsgs.length; i++) {
      var sendmsg = this._allSendMsgs[i]
      var random1 = sendmsg.randomNum1;
      var random2 = sendmsg.randomNum2;
      var cv = 10;
      var value = 1
      if (type == sendmsg.type) {
        var str = `<r${random1}|${random2}|${cv} ${value}>`
        var ab = hex2ab(str2hex(str))
        bleManager.readMsg(ab)
      }
    }
  },
  tap2: function() {
    console.log(this._allSendMsgs)
    var type = bleManager.type.carAddress_set_high128_17_write
    for (let i = 0; i < this._allSendMsgs.length; i++) {
      var sendmsg = this._allSendMsgs[i]
      var random1 = sendmsg.randomNum1;
      var random2 = sendmsg.randomNum2;
  ...
  tap3: function() {
    console.log(this._allSendMsgs)
    var type = bleManager.type.carAddress_set_high128_18_write
    for (let i = 0; i < this._allSendMsgs.length; i++) {
      var sendmsg = this._allSendMsgs[i]
      var random1 = sendmsg.randomNum1;
      var random2 = sendmsg.randomNum2;
  ...
  tap4: function() {
    console.log(this._allSendMsgs)
    var type = bleManager.type.carAddress_set_high128_sixValue_0_write
    for (let i = 0; i < this._allSendMsgs.length; i++) {
      var sendmsg = this._allSendMsgs[i]
      var random1 = sendmsg.randomNum1;
      var random2 = sendmsg.randomNum2;
